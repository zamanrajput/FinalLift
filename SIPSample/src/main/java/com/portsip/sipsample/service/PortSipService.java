...
public class PortSipService extends Service implements OnPortSIPEvent, NetWorkReceiver.NetWorkListener {
    ...
    private void initialSDK() {
        ...
        AdminConfig config = new SharedPreUtil(this).getConfig();
        try {
            transType = getTransType(config.transportProtocol);
        } catch (Exception e) {
            transType = getTransType(0);
            e.printStackTrace();
        }
    ...
    private void showServiceNotification() {
        Intent intent = new Intent(this, MainSIPActivity.class);
    ...
    public void registerToServer() {
        ...
        serverPort = String.valueOf(config.port);
...
//        }
    ...
    public void onInviteAnswered(long sessionId,
        ...
        try{
            HomeActivity.callInProgress();

        }catch (Exception e){
            e.printStackTrace();
        }
        log("OnInvite Answared");
    ...
    public void onInviteFailure(long sessionId, String reason, int code, String sipMessage) {
        ...
        log("OnInvite Failure");

        HomeActivity.endCall();
    ...
    public void onInviteUpdated(long sessionId, String audioCodecs, String videoCodecs, String screenCodecs, boolean existsAudio, boolean existsVideo, boolean existsScreen, String sipMessage) {
        ...
        log("OnInvite Updated");
    }

    public void log(String s) {
        Log.i("SIP Service", "log: " + s);
    }
